...
class JWT
{
    ...
    /**
    * Método estático responsável por gerar o token JWT utilizando os demais métodos abaixo.
    * 
    * @param array $data Dados.
    *
    * @return string $jwt Token JWT.
    */
    ...
    public static function verify(string $jwt)
    {
        ...
        // Verifica se existem as 3 partes do token
        if (count($tokenPartials) != 3) return false;

        // Pega as informações contidas em cada parte do token
